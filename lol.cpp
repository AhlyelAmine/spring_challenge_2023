...
bool crystals_amount_85(int initial_crystals, int crystals)
{
    if (crystals * 100 / initial_crystals > 85)
        return (1);
    return (0);
}
...
int get_min(vector<pair<int, int> > eggs)
{
...
int main()
{
    ...
    while (1) {
		...
		exit(1);
        // for (int i = 0; i < number_of_cells; i++){
        //     if (loop == 1 || crystals_amount_85(initial_crystals, crystals)){
        ...
        // }
        // if (eggs_saved){
        //     cout << "LINE " << get_min(egg_index) << " " << my_base_index << " 1;";
        //     egg_index.clear();
        // }
        // if (!couted){
        //      for (int i = 0; i < number_of_cells; i++){
