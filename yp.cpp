        ...
        if (((is_egg == 1) || is_egg == 3) && a[i].type == 1 && b[i].resources){
            if (is_egg == 3){
                bfsPath.insert(make_pair(i, bfs_path(a, b, number_of_cells, i, hasResources))); // take all paths have eggs from base in a map
                        cout << "MESSAGE bfs_path hasResources;";
            }
            else
            {
                        cout << "MESSAGE bfs_path hasEggs;";
            ...
            if (is_egg == 3){
                ...
                bfsPath.insert(make_pair(i, bfs_path(a, b, number_of_cells, i, hasCrystals))); // take all paths have eggs from base in a map
                        cout << "MESSAGE bfs_path hasCrystals;";
            }
        }
    }
...
int main()
{
    ...
    while (1337) {
        ...
        try {
            ...
            if (cells_eggs && (((crystals * 100.0) / initial_crystals > 75.0))){ // eggs true crystals > 75
            ...
            if ((cells_eggs && (((crystals * 100.0) / initial_crystals > 75.0))) || (cells_eggs && ((crystals * 100.0) / initial_crystals < 75.0)) ){ // eggs true crystals > 75{}
